...
Cela importe parce que [la recherche est claire](/fr/donnees-probantes/) : les rétroactions régulières des participant·e·s améliorent les résultats jusqu'à 65 % pour les personnes à risque d'abandon. La relation de travail entre le·la participant·e et l'intervenant·e — mesurée du point de vue du·de la participant·e, pas de l'intervenant·e — est le meilleur prédicteur du fait qu'un programme aide vraiment. KoNote fait de ces pratiques la voie de moindre résistance plutôt qu'un complément qui nécessite des efforts supplémentaires.
